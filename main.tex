...
berusande och psykotropiska egenskaperna hos muskotnöt.
...
med att djurprover (djur toxiologi studier) som visat att den innehåller samma
verkan som den hela nöten.
Mänskliga experiment med riven muskotnöt tömd på sina flyktiga oljor har
misslyckats med att visa någon form av psykofarmakologiskt svar. (låter konstigt ska ändra) (källa 7 shulgin)
...
Det kan å andra sidan ha någon funktion i upptaget av olika aromatiska etrar i
magsäcken.

Den aromatiska fraktionen är den som verkar vara den mest troliga källan av de
berusande effekterna av muskotnöt. \textbf{2} visar strukturerna av varje
förening återfunnen i den aromatiska fraktionen. Även visat är mängden i milligram
som skulle återfinnas i 20g av en hel muskotnöt, det antaget vara dosen som krävs
för berusande effekter.

\hbox{\hspace{-1.5cm}\includegraphics[scale=0.12]{Tabell2}
\caption{\textbf{Tabell 2}}
}
